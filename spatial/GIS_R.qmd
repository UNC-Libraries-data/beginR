...
By adding `tmap_mode("view")` before our code, we can make an interactive map.  Let's also use some of our `tidyverse` tools to subset our `housing` dataframe so we can leave the pop ups on.
