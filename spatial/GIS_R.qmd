...
[`tmap`](https://r-tmap.github.io/tmap/) is another popular package for making thematic maps.
...
#| fig-width: 12
#| fig-height: 5
tm_basemap("Stadia.StamenTonerLite")+
  tm_shape(nc_csas)+
  tm_polygons(fill="NAME", fill_alpha = 0.5,
